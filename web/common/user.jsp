    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="menuItem" href="${pageContext.request.contextPath}/admin/update/${user.uid}"><i
                            class="fa fa-gear"></i><span class="nav-label">个人中心</span></a>
                </li>
                <li>
                <li>
                    <a class="menuItem" href="${pageContext.request.contextPath}/common/preview.jsp"><i
                            class="fa fa-cubes" aria-hidden="true"></i><span class="nav-label">活动预览</span></a>
                </li>
                <li>
                    <a class="menuItem" href="${pageContext.request.contextPath}/common/myevent.jsp"><i
                            class="fa fa-cubes" aria-hidden="true"></i><span class="nav-label">我的活动</span></a>
                </li>
                <li>
