...
<script type="text/javascript">
    ...
    $(function ()
    {
        $("input[name='eventname']").val("${event.eventname}");
        ...
        $("input[name='length']").val("${event.length}");
        $("input[name='maxperson']").val("${event.maxperson}");
        $("input[name='totalmoney']").val("${event.totalmoney}");
    });
    ...
    function update()
    {
        ...
        $.ajax({
            ...
            success: function (r)
            {
                if (r.code == 0)
                {
                    layer.alert("<font color='red'>更新活动：" + r.msg + " 成功！</font>", {
                            icon: 1,
                            title: "系统提示"
                        },
                        function ()
